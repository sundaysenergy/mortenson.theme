...
$(document).ready(function() {
  var $slide, anime_by_size, data, endpoint, index, make_id, new_slide, next_item, remove_transition_anim, sec_per_slide, slide, template, update;
  if (!window.make_id) {
    make_id = 'mortenson';
